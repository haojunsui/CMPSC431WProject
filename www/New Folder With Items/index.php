...
<div id="header-wrapper">
	<div id="header" class="container">
		<div id="logo">
			...
			<h1><a href="#">BigLegCarry</a></h1>
			<span>Team members: Haojun Sui, Yuanpei Deng, Hao Wang, Yuqing Shi, Chenyu Zhang</a></span> </div>
		<div id="menu">
			<ul>
				...
				<li><a href="#" accesskey="6" title=""><input type="text" name="text1" id="text1" /></a></li>
			</ul>
		</div>
	</div>
</div>
